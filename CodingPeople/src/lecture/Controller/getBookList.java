...
@WebServlet("/lecture/getBookName.do")
public class getBookList extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//2. 쿼리 실행하여 list 담기
		List<BookInfoVO> list = lectureService.getBookList(categoryId);
		
		//3. 리퀘스트 객체에 list 담기
		req.setAttribute("list", list);
		
		// 4. 디스패쳐에 리퀘스트 객체 담기
		RequestDispatcher dispatcher = req.getRequestDispatcher("/lecture/bookList.jsp");
