...
@WebServlet("/groupStudy/list.do")
public class GroupStudyInfo extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 4. 디스패쳐에 리퀘스트 객체 담기
		RequestDispatcher dispatcher = req.getRequestDispatcher("/groupStudy/viewGroupStudy.jsp");
