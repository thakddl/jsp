			...
			<section id="contents_lecturebuymenu">
				...
				<div id="lecturebuymenu_center">
					<ul id="lecturebuymenu">
						<li>
							<div id="lecturebuymenudiv2">강좌 시청하기</div>
                ...
                %>
									...
									<tr>
										<td class="imgtd" rowspan="3"><img
											src="../img/<%=csList.get(i).getCourseId().replace(" ", "")%>.jpg"></td>
										<td>강의명</td>
										<td colspan="3"><%=csList.get(i).getCourseTitle() %></td>
									</tr>
									<tr>
										<td class="td1">가격</td>
										<td class="td2"><%=csList.get(i).getCoursePrice() %></td>
										<td colspan="2"><button type="button"
												onclick="window.open('/lecture/view.do?courseId=<%=csList.get(i).getCourseId()%>','pop1');return false;">시청하기</button></td>
									</tr>
									<tr>
										<td>강의수</td>
										<td><%=csList.get(i).getCourseComposition() %></td>
										<td class="td1">구분</td>
										<td class="td2"><%=csList.get(i).getCategoryId() %></td>
									</tr>
									<tr>
