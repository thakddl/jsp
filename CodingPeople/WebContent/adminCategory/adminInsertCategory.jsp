          ...
          <div class="container">
			  <form class="form-horizontal" action="/admin/insertCategory.do" method="POST">
			    <div class="form-group">
			      <label class="control-label col-sm-2">카테고리ID</label>
			      <div class="col-sm-10">
			        <input class="form-control" id="ctgrId"  name="ctgrId">
			      </div>
			    </div>
			    <div class="form-group">
			      <label class="control-label col-sm-2">카테고리명</label>
			      <div class="col-sm-10">          
			        <input type="text" class="form-control" id="ctgrName" name="ctgrName">
			      </div>
			    </div>
			    <div class="form-group">        
			    ...
			    <div class="form-group">        
			      <div class="col-sm-offset-2 col-sm-10">
			        ...
			        <button type="submit" class="btn btn-default">카테고리 등록</button>
