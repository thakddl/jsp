...
public class TestScheduler {
	...
	/* @Scheduled(fixedRate = 1000 * 5) 무기한 주기적 무기한이라 잘안쓴다 크론으로도 충분히 할수있다*/
	//@Scheduled(cron = "*/5 * * * * *") //어노테이션으로 박아버리면 위험해 쩜 자바 없으면 안되니까 빈 등록하쟈
	public void testMessage() {//단 리턴과 파라미터 안된다.
