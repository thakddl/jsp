...
@WebServlet(value="/questionboard/list.do")
public class DisplayQuestionBoardServlet extends HttpServlet{
	
	private static final long serialVersionUID = 1L;
	
	public DisplayQuestionBoardServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<QuestionBoardVO> boardList = boardService.displayBoard();
		
		req.setAttribute("boardList", boardList);
		RequestDispatcher dispatcher = req.getRequestDispatcher("/questionboard/list.jsp");
...
//		System.out.println("double 미사용>>> " + 21 / perList);
		...
		List<QuestionBoardVO> list = service.boardList(map);
