		...
		<div class="container">
			...
			<section id="contents_freeboard">
				...
				<div id="freeboard_center">
					<div id="freeboard">
						자유게시판 <input type="button" id="freeboard_buttons" value="검색하기">
					...
					<div id="freeboard2">
						<button class="btn btn-primary" type="button" id="freeboard2button"
							onclick="location.href='board/insert.do?boardId=1'">게시글작성</button>
					</div>
				</div>
